...
from core.data_and_funcs import default_customer_priorities
...
class CustomerOffer(Statuses):
    ...
    selected_car = models.JSONField(encoder=None,
                                    decoder=None,
                                    default=default_customer_priorities)

    class Meta:
        db_table = "customer_offer"

    def __str__(self):
        return f"Customer {self.customer} is looking for a {self.selected_car['price']} $ car"
